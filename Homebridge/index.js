...
module.exports = function (homebridge) {
    ...
    homebridge.registerPlatform("homebridge-markisol", "MarkisolPlatform", MarkisolPlatform, true);
}

class MarkisolPlatform {
    ...
    addAccessory(accessoryName) {
        ...
        newAccessory.addService(Service.WindowCovering, "Roller Blind")
